...
const Subscribe = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-black rounded-lg w-full max-w-md text-white relative p-4"
      ...
      >
        ...
        <form onSubmit={handleSub} className="bg-[#f5f5f5] p-6 rounded-lg">
          ...
          <button
            type="submit"
            className="border-[1px] border-white text-[18px] bg-[#f23e5a] text-white p-4 rounded-lg w-full hover:bg-white hover:text-black mt-4 backdrop-blur-5"
