...
export default function Unit() {
  return (
    <main lang="es" className='flex min-h-screen flex-col items-center justify-center px-4 py-10 sm:px-6'>
        ...
        <Link href="/manifesto" className='block text-white bg-transparent text-center rounded-lg border-2 border-white p-4 mb-2 hover:bg-white hover:text-black'>
        📢 DAO</Link>
