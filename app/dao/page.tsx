...
export const metadata: Metadata = {
  title: 'DAO',
  description: 'ZUYUX DAO: gobernanza descentralizada en Optimism y transparencia mediante contratos inteligentes.',
}
  ...
  return (
    <main className='flex flex-col items-center justify-center pb-20'>
        <div className='rounded-3xl mt-8 p-8 w-full lg:max-w-md mb-24 text-2xl border-[1px] border-white'>
          ...
          <p className='mt-6 mb-6'><strong>ZUYUX</strong> funciona como una <strong>DAO</strong> [<Link href="https://es.wikipedia.org/wiki/Organizaci%C3%B3n_aut%C3%B3noma_descentralizada" target='_blank' rel='noopener noreferrer' className='hover:underline'><strong>Organización Autónoma Descentralizada</strong></Link>], entidad directiva sin intermediarios que opera en la blockchain de <Link href="https://optimism.io" target="_blank" rel='noopener noreferrer' className='hover:underline font-bold'>Optimism</Link>. </p>
